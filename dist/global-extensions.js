...
function logExtensionsAdded() {
    ...
    console.groupCollapsed(`%c🎉%cNew functions successfully added to your project: %c🎉`);
    logs.forEach(({ fnName, objName }) => console.log(`${fnName}%cwas set as new property to%c${objName}`, emojiStyle, nameStyle, defaultStyle, nameStyle, emojiStyle));
    console.groupEnd();
}
/** Math */
if (!Math.randomInt) {
