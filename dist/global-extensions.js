...
function logExtensionsAdded() {
    ...
    console.group();
    logs.forEach(({ fnName, objName }) => console.log(`%c🎉%c${fnName}%cwas successfully set as new property to%c${objName}%c🎉`, emojiStyle, nameStyle, defaultStyle, nameStyle, emojiStyle));
    console.groupEnd();
}
/** Math */
if (!Math.randomInt) {
